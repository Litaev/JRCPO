...
public:
    ...
    virtual QJsonObject toJson() const {
        ...
        eventObj["eventType"] = static_cast<int>(eventType);
        eventObj["eventName"] = eventName;
        eventObj["eventPrice"] = eventPrice;
        eventObj["eventDate"] = eventDate.toJson();
        eventObj["eventMileage"] = eventMileage;
        eventObj["eventComment"] = eventComment;
        return eventObj;
    }
