...
class Car : public Presaveable, public Preloadable{
    ...
    CustomContainer<std::shared_ptr<Event>> eventList;
    Statistics carStatistics;
public:
    void setCar(QString newCarName, QString newCarYear, QString newCarMileage, QString newCarFuelType, QString newCarTankVolume, QString newCarFilepath);
    ...
    CustomContainer<std::shared_ptr<Event>> &getEventList();
    ...
    QJsonObject toJson(int chosenEventType, int chosenEventMinPrice) const;
